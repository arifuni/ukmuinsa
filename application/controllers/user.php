...
class user extends CI_Controller
{
    ...
    public function edit()
    {
        ...
        $this->form_validation->set_rules('name', ' ', 'trim|required', array('trim' => '', 'required' => '{field} wajib diisi.'));
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert"> Selamat! Profil anda berhasil diperbarui!
          </div>');
            redirect('user');
        }
    }
